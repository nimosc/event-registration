...
export default function NavBar({ userName, userRole, userLocation, adminMode = "candidacy" }: NavBarProps) {
  ...
  return (
    <nav className="bg-white border-b border-gray-200 shadow-sm sticky top-0 z-50">
      {/* Brand accent bar */}
      <div className="h-1 bg-gradient-to-l from-blue-500 via-indigo-500 to-purple-500" />
      <div className="max-w-6xl mx-auto px-4 sm:px-6">
        <div className="flex items-center justify-between h-16">
          {/* Logo + divider + Desktop Nav Links */}
          <div className="flex items-center gap-4">
            ...
            <span className="hidden md:block h-8 w-px bg-gray-200" />
                ...
                return (
                  <Link
                    ...
                    className={`px-4 py-1.5 rounded-full text-sm font-medium transition-all duration-150 ${
                      isActive
                        ? "bg-gradient-to-l from-blue-500 to-indigo-500 text-white shadow-lg shadow-blue-500/30"
          ...
          {/* User card + actions */}
          <div className="flex items-center gap-3">
            <div className="hidden sm:flex items-center gap-2.5 rounded-full border border-gray-200 bg-white py-1 ps-1 pe-3 shadow-sm">
              <span className="flex h-8 w-8 items-center justify-center rounded-full bg-gradient-to-br from-blue-500 to-indigo-500 text-white text-sm font-bold">
                {userInitial}
              </span>
            ...
            <button
              ...
              className="hidden sm:flex items-center gap-1.5 rounded-lg border border-red-200 bg-red-50 px-3 py-1.5 text-xs font-semibold text-red-600 hover:bg-red-100 transition-colors duration-150"
              title="דיווח תקלה"
            >
              <svg
            ...
            <button
              ...
              disabled={loggingOut}
              className="hidden sm:flex items-center gap-1.5 text-sm text-gray-400 hover:text-gray-700 transition-colors duration-150 disabled:opacity-50"
            >
              <svg
                className="w-4 h-4"
                fill="none"
              ...
              return (
                <Link
                  ...
                  className={`block px-3 py-2 rounded-lg text-sm font-medium transition-colors duration-150 ${
                    isActive
                      ? "bg-gradient-to-l from-blue-500 to-indigo-500 text-white shadow-sm"
